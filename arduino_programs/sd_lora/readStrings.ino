//Function for reading response of quectel m95
/*
 * Function Name: readStrings
 * Input: none
 * Output:  none
 * Logic: reads & stores the response of GPRS & GSM module & returns a value based on the response
 * Example Call: readStrings()
 */
