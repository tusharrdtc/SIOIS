...
{ 
  ...
  if(flagGprs == 4)
  {
    int len = sprintf(url, "https://www.senseitout.com/write_data_test.php?&data3=%d&data4=%d&data5=%d&data8=%d&data9=%d&data11=%d&data14=%d&data15=%s", from, rssiPos, soilMoist, temp, hum, soilTemp, pumpStat, batvalue);
